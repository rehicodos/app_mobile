...
class EditSortieMat extends StatefulWidget {
  final SortieMatModel sortieMat;
  const EditSortieMat({super.key, required this.sortieMat});

  @override
  EditSortieMatState createState() => EditSortieMatState();
}

class EditSortieMatState extends State<EditSortieMat> {
  ...
  void initState() {
    ...
    _designController = TextEditingController(text: widget.sortieMat.design);
    _qteController = TextEditingController(text: widget.sortieMat.qte);
    _lieuController = TextEditingController(text: widget.sortieMat.lieu);
  }
    ...
    try {
      final response = await http
          .post(
            ...
            body: jsonEncode({
              "action": "edit_sortie_mat",
              "id": widget.sortieMat.id.toString(),
