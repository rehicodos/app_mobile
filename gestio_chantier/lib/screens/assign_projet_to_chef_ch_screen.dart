...
class AssignProjetToChefChScreen extends StatefulWidget {
  final int idChefCh;
  const AssignProjetToChefChScreen({super.key, required this.idChefCh});

  @override
  State<AssignProjetToChefChScreen> createState() =>
      _AssignProjetToChefChScreenState();
}

class _AssignProjetToChefChScreenState
    extends State<AssignProjetToChefChScreen> {
  ...
  Future<void> _assigner(int idp, projet) async {
    try {
      final reponse = await http
          .post(
            ...
            body: jsonEncode({
              "action": "assigner_projet",
              'idp': idp.toString(),
              'idChef': widget.idChefCh.toString(),
              'projet': projet,
            }),
          )
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: ConnectionOverlayWatcher(
        child: Scaffold(
          appBar: AppBar(title: Text("Assignation projet"), centerTitle: true),
          body: _loading
                          ...
                          return Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextButton.icon(
                                  onPressed: () => _assigner(w.id, w.nom),
                                  label: Icon(
                                    Icons.add_circle,
                                    size: 28,
                                    color: Colors.blue,
