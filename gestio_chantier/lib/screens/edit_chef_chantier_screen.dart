...
class EditeChefChantier extends StatefulWidget {
  final ChefChantierModel chefCH;
  const EditeChefChantier({super.key, required this.chefCH});

  @override
  EditeChefChantierState createState() => EditeChefChantierState();
}

class EditeChefChantierState extends State<EditeChefChantier> {
  ...
  void initState() {
    ...
    _nomController = TextEditingController(text: widget.chefCH.nom);
    _telController = TextEditingController(text: widget.chefCH.tel);
    _pwdController = TextEditingController(text: widget.chefCH.pwd);
  }
    ...
    try {
      final response = await http
          .post(
            ...
            body: jsonEncode({
              "action": "edit_chef_chantier",
              "id": widget.chefCH.id.toString(),
